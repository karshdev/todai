...
const createRequestWithAuth = async (method: 'get' | 'post' | 'patch' | 'put' | 'delete', url: string, data?: any, isFormData = false) => {
    // if (controller) {
    //     controller.abort();
    // }
...
export const postDataWithToken = (url: string, data: any, isFormData = false) => createRequestWithAuth('post', url, data, isFormData);

export const patchDataWithToken = (url: string, data: any, isFormData = false) => createRequestWithAuth('patch', url, data, isFormData);

export const putDataWithToken = (url: string, data: any, isFormData = false) => createRequestWithAuth('put', url, data, isFormData);

export const deleteDataWithToken = (url: string) => createRequestWithAuth('delete', url);
