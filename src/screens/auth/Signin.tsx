    ...
    return (
        <div className='p-8 md:p-18 lg:p-28 flex flex-col justify-center items-center w-full h-full'>
            ...
            <div className='w-full flex flex-col gap-4 '>
                ...
                <h3 className='text-lg font-semibold'>Dont have an account? <a href="/signup" className='text-blue-500'>Sign Up.</a></h3>
            ...
            <div className='w-full mt-5'>
                <button className='border p-5 w-full rounded-md font-semibold'>
                    <div className='flex gap-3 justify-center items-center' onClick={() => signIn('google', { callbackUrl: `${process.env.NEXTAUTH_URL}/?type=signin` })}>
